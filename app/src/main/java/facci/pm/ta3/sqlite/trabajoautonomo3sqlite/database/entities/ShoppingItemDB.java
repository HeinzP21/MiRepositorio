...
public class ShoppingItemDB {
    ...
    public void insertElement(String productName) {
        ...
        //Partimos por obtener el repositorio de datos en modo de escritura, esto nos permite trabajar
        //con el mismo ( esto se va a hacer en cada una de las secciones de código a trabajar)
        SQLiteDatabase db = dbHelper.getWritableDatabase();

        //Creamos un nuevo mapa de valores, en el cual vamos por medio de un .put agregarle los nombres
        //de los productos que va a mostrar nuestra lista
        ContentValues values = new ContentValues();
        values.put(ShoppingElementEntry.COLUMN_NAME_TITLE, productName);

        //Por último, gracias al método .insert agregamos estos elementosa nuestra tabla
    ...
    public void clearAllItems() {
        ...
        /*Estas 2 lineas de código nos sirve para evitar que los datos se dupliquen cada vez que se
          vuelve a abrir el programa, y asi lograr que la lista contenga solo la cantidad de elementos
          que definimos al principio
        */

        SQLiteDatabase db = dbHelper.getWritableDatabase();
        //Por medio del método .delete eliminamos esta tabla al asignar valores null
    ...
    public void updateItem(ShoppingItem shoppingItem) {
        ...
        //En esta linea asignamos los titulos que van a ser ingresados
        values.put(ShoppingElementEntry.COLUMN_NAME_TITLE,title);
        //Aqui se selecciona la ID en la cual va a ser actualizados los productos
        String selection = ShoppingElementEntry._ID + " = ?";
        //Se obtiene la ID de estos elementos para saber su posición
        String[] selectionArgs = {String.valueOf(shoppingItem.getId())};
        //Y por último se usa el método .update para actualizar la lista
        int updateRows = db.update(ShoppingElementEntry.TABLE_NAME,
                values,
                selection,
                selectionArgs);
    ...
    public void deleteItem(ShoppingItem shoppingItem) {
        ...
        //A diferencia del .delete en el cual borramos toda la lista, en este solo borramos
        //las tablas que deseamos y previamente fueron asignadas en el MainActivity, esto
        //se logra gracias al métoo .delete
